...
import { storefrontApiRequest, formatCheckoutUrl } from "@/lib/shopify";
...
async function updateShopifyCartLine(
  ...
  const data = await storefrontApiRequest<{ cartLinesUpdate: { userErrors: UserError[] } }>(
...
async function removeLineFromShopifyCart(
  ...
  const data = await storefrontApiRequest<{ cartLinesRemove: { userErrors: UserError[] } }>(
